  ...
  <head>
    ...
    <script type="text/javascript">     
        ...
        {     
            $.ajax
            ({
                url: '<? echo site_url('report/generate_available_stocks_report_xls');?>',
                type: 'POST',  
                ...
                <div class="col-lg-20">
                    <div class="well">
                        ...
                        <div align="center">   
                            ...
                            <table id="table_available_stocks_report" border=0>
                                <tr>
                                    <td class="table_label"><b>ITEM GROUP</b></td>
                                    <td class="table_colon">:</td>
                                    <td class="table_data" colspan="2">
                                        <select name="cmb_item_group" id="cmb_item_group"
                                        style="height:30px; width: 400px;">   
                                            <option value="0">Select</option>  
                                            <?php foreach($get_item_group_name as $row){ ?>
