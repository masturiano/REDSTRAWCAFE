    ...
    <script type="text/javascript">     
        ...
        {     
            if($('#txt_date_from').val() == 0){
                bootbox.alert("Please select Date Enter from!", function() {
            ...
            if($('#txt_date_to').val() == 0){
                bootbox.alert("Please select Date Enter to!", function() {
            ...
            $.ajax
            ({
                url: '<? echo site_url('report/generate_cancelled_order_report_xls');?>',
                type: 'POST',  
                ...
                <div class="col-lg-20">
                    <div class="well">
                        ...
                        <div align="center">   
                            ...
                            <table id="table_detailed_report" border=0>
                                <tr>
                                    <td class="table_label"><b>DATE ENTER</b></td>
                                ...
                                <tr>
                                    <td class="table_label"><b>ITEM GROUP</b></td>
                                    <td class="table_colon">:</td>
                                    <td class="table_data" colspan="2">
                                        <select name="cmb_branch_group" id="cmb_branch_group"
                                        style="height:30px; width: 400px;">   
                                            <option value="0">Select</option>  
                                            <?php foreach($get_branch_name as $row){ ?>
